						...
						<NavigationMenuTrigger hideChevron={true} className="bg-transparent p-0 pr-5">
							...
							<div className="w-5 h-full relative">
								<div className="block w-5 absolute left-1/2 top-1/2   transform  -translate-x-1/2 -translate-y-1/2">
									<span className={`block absolute h-0.5 w-5 bg-current transform transition duration-300 ease-in-out ${(open !== '') ? "rotate-45" : "-translate-y-1.5"}`}></span>
									<span className={`block absolute  h-0.5 w-5 bg-current   transform transition duration-300 ease-in-out ${(open !== '') ? "opacity-0" : ""}`}></span>
