...
interface AnimeCardProps {
	data?: AnimeEntry;
	animation?: boolean;
	onOpen?: (data: AnimeEntry) => void;
}

export const AnimeCard = memo(function AnimeCard({ data, animation = true, onOpen }: AnimeCardProps) {
	...
	return <AnimeDialog data={data}>{card}</AnimeDialog>;
});
